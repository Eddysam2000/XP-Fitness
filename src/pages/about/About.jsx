    ...
    <section className="about_mission">
      <div className="container about_mission-container">
        ...
        <div className="about_section-content">
          <h1>Our Mission</h1>
          <p>
          Lorem ipsum, dolor sit amet consetetur adipisicing elit. Unde quis corporis amet, neque provident culpa dolorum voluptatum libero quasi voluptate aspernatur debitis numquam consequatur mollitia. id eveniet dignissimos cum.
          </p>
          {/* <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis fugit et rerum cupiditate dolores earum voluptates pariatur debitis porro eveniet Provident, facere laudantium?
          </p> */}
