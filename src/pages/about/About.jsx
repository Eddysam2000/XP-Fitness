    ...
    <section className="about_vision">
      <div className="container about_vision-container">
        <div className="about_section-content">
          <h1>Our Vision</h1>
          <p>
            Lorem ipsum, dor sit amet consectetur adipisicing elit. Unde quis corporis amet, neque provident culpa dolorum deserunt odio dolorem id eveniet dignissimos cum.
          </p>
          <p>
